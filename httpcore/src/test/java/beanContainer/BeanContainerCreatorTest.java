...
class BeanContainerCreatorTest {
    ...
    void test0() throws Exception {
        ...
        //when
        Map<Class<?>, Object> actual = BeanContainerCreator.create(List.of(Controller1.class, Controller2.class));
    ...
    void test1(List<Class<?>> classes) throws Exception {
        //given
        //when
        Throwable actual = Assertions.catchThrowable(() -> BeanContainerCreator.create(classes));
    ...
    public static Stream<Arguments> provideCircularRefClasses() {
        return Stream.of(
            Arguments.of(List.of(SelfRefController.class)),
            Arguments.of(List.of(CircularRefController.class))
        );
    }
