...
public class SocketHttpEventPublisher {
    private final ExecutorService executorService;
    private final ServerSocket serverSocket;

    public SocketHttpEventPublisher(ExecutorService executorService, ServerSocket serverSocket) {
        this.executorService = executorService;
        this.serverSocket = serverSocket;
    }

    public static SocketHttpEventPublisher create(int threadPoolCount, int port) {
        ExecutorService executorService = Executors.newFixedThreadPool(threadPoolCount);
        ServerSocket serverSocket = createServerSocket(port);
        return new SocketHttpEventPublisher(executorService, serverSocket);
    }

    public static SocketHttpEventPublisher create(int port, int maxConnection, int waitConnection, long keepAliveTime){
        ...
        ServerSocket serverSocket = createServerSocket(port);
        return new SocketHttpEventPublisher(threadPoolExecutor, serverSocket);
    }
