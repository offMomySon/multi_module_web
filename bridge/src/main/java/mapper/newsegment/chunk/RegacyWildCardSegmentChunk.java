...
public class RegacyWildCardSegmentChunk implements SegmentChunk {
    private static final String WILD_CARD = "**";

    private final List<String> segments;

    public RegacyWildCardSegmentChunk(List<String> segments) {
    ...
    public static RegacyWildCardSegmentChunk from(String... segments) {
        Objects.requireNonNull(segments);
        return new RegacyWildCardSegmentChunk(Arrays.stream(segments).filter(Objects::nonNull).collect(Collectors.toUnmodifiableList()));
    }
